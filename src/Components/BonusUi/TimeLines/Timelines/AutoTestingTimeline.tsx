...
const AutoTestingTimeline = () => {
  ...
  return (
    <VerticalTimelineElement className="vertical-timeline-element--work" date="June 12 2022" icon={<i className="icon-pulse"></i>} iconClassName="cd-timeline-img cd-location bg-info">
