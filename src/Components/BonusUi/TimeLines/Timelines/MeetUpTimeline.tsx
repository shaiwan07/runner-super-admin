...
const MeetUpText: string = "Find nearby web designers to network with! A Web Design Meetup is a place where you can discuss tools.";
   ...
   return (
     <VerticalTimelineElement className='vertical-timeline-element--work' date='November 04 2022' icon={<i className='icon-pin-alt'></i>} iconClassName='cd-timeline-img cd-location bg-secondary'>
