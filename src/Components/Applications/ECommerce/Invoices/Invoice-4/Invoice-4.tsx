...
const InvoiceFourContainer = () => {
  ...
  return (
    <>
      <Breadcrumbs mainTitle={InvoiceFour} parent={Invoice} title=""/>
        ...
        <div ref={componentRef}>
          <Table borderless style={{ width: 1160, margin: "0 auto", }}>
            <tbody>
              ...
              <tr>
                <td style={{ height: 3, width: "100%", background: "linear-gradient(90deg, #5C61F2 20.61%, #FF9766 103.6%)", display: "block", padding:"0px" }} />
              </tr>
              <tr>
                <InvoiceTotal />
              </tr>
